"""
MMaDA Safety Evaluation Script

Runs safety evaluations on MMaDA-8B-MixCoT using the LSB framework.

Usage:
    python run_evaluation.py --output results/mmada
...
if VERSION != REQUIRED_VERSION:
    print(f"\n❌ ERROR: MMaDA requires transformers=={REQUIRED_VERSION}")
...
def main():
    parser = argparse.ArgumentParser(description="Evaluate MMaDA on LSB safety benchmark")

    parser.add_argument("--model-path", default="Gen-Verse/MMaDA-8B-MixCoT")
    ...
    logger.info("="*70)
    logger.info("MMaDA Safety Evaluation")
    logger.info("="*70)
